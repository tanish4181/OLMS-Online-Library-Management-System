      ...
      <div class="row align-items-center">
          ...
          <div id="demo" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner rounded">
              <div class="carousel-item active">
                <img src="/olms/asset/images/1.jpeg" class="d-block w-100" alt="Browse Books" />
              </div>
              <div class="carousel-item">
                <img src="/olms/asset/images/library1.png" class="d-block w-100" alt="Library 1" />
              </div>
              <div class="carousel-item">
                <img src="/olms/asset/images/2.jpeg" class="d-block w-100" alt="Library 2" />
              </div>
            </div>
            <button class="carousel-control-prev" type="button" data-bs-target="#demo" data-bs-slide="prev" style="background: transparent; border: none">
              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
              <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#demo" data-bs-slide="next" style="background: transparent; border: none">
        ...
        <div class="col-md-6">
          <div class="home-content rounded">
            ...
            <a href="/olms/auth/UserLogin.php" class="btn btn-outline-secondary mt-3">Login Now</a>
          </div>
        </div>
      </div>
    </div>
